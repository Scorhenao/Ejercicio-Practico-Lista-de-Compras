...
// • Muestra la lista ordenada en la consola. 
    ...
    functionTotalShopping = (array,price) =>{
        ...
        console.log(`El total de la compra es: ${functionUnits(total)}`);
        console.log(`El total de la compra con IVA es: $${functionUnits(totalIva)}`);

        alert(`El total de su compra es: ${functionUnits(total)}`)
        alert(`El total de su compra con IVA es: ${functionUnits(totalIva)}`)
    }
...
//-----------------------------------------------------------------------------------------------------------
    ...
    console.log(functionOrderList(listShopping));
